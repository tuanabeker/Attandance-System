...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\Pc\VScode prject\college_images\register.jpg")
        bg_lbl = Label(self.root, image=self.bg)
        bg_lbl.place(x=0, y=0, relwidth=1, relheight=1)

        # ===========left image==========
        self.bg1 = ImageTk.PhotoImage(
            file=r"C:\Users\Pc\VScode prject\college_images\education.jpg")
        ...
        # =========== buttons================
        img = Image.open(
            r"C:\Users\Pc\VScode prject\college_images\registerbtn.jpg")
        ...
        img1 = Image.open(
            r"C:\Users\Pc\VScode prject\college_images\loginnow.jpg")
    ...
    def register_data(self):
        if self.var_fname.get() == "" or self.var_email.get() == "" or self.var_securityQ.get() == "Select":
            ...
            conn = mysql.connector.connect(
                host="localhost", user="root", password="4656", database="mydata")
